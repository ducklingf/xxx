(function () {
    ...
    function startxxx() {
      ...
      Lampa.Listener.follow('app', function (e) {
        if (e.type == 'ready') {
          ...
          var menu_item = $('<li class="menu__item selector focus" data-action="xxx"><div class="menu__ico">' + ico + '</div><div class="menu__text">Клубничка</div></li>');
    ...
    if (!window.plugin_xxx_ready) startxxx();
